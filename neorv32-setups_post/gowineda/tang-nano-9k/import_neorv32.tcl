...
# aggiunta di cocciasecca
set aes_corefiles [glob $import_neorv32_dir/rtl/core/aes/*.vhd]
set corefiles [concat $corefiles $aes_corefiles]
# fine cocciasecca's entries
